...
case RLC_dHL: tByte=rom[HL]; RLC(tByte); break;
...
case RRC_dHL: tByte=rom[HL]; RRC(tByte); rom[HL]=tByte; break;
...
case RL_dHL: tByte=rom[HL]; RL(tByte); rom[HL]=tByte; break;
...
case RR_dHL: tByte=rom[HL]; RR(tByte); rom[HL]=tByte; break;
...
case SLA_dHL: tByte=rom[HL]; SLA(tByte); rom[HL]=tByte; break;
...
case SRA_dHL: tByte=rom[HL]; SRA(tByte); rom[HL]=tByte; break;

case SLR_A:   SLR(A); break;
case SLR_B:   SLR(B); break;
case SLR_C:   SLR(C); break;
case SLR_D:   SLR(D); break;
case SLR_E:   SLR(E); break;
case SLR_H:   SLR(H); break;
case SLR_L:   SLR(L); break;
case SLR_dHL: tByte=rom[HL]; SLR(tByte); rom[HL]=tByte; break;
...
case SWAP_dHL: tbyte=rom[HL]; SWAP(tByte); rom[HL]=tByte; break;
...
case BIT_0_dHL: tByte=rom[HL]; BIT(0,A); rom[HL]=tByte; break;
...
case BIT_1_dHL: tByte=rom[HL]; BIT(1,A); rom[HL]=tByte; break;
...
case BIT_2_dHL: tByte=rom[HL]; BIT(2,A); rom[HL]=tByte; break;
...
case BIT_3_dHL: tByte=rom[HL]; BIT(3,A); rom[HL]=tByte; break;
...
case BIT_4_dHL: tByte=rom[HL]; BIT(4,A); rom[HL]=tByte; break;
...
case BIT_5_dHL: tByte=rom[HL]; BIT(5,A); rom[HL]=tByte; break;
...
case BIT_6_dHL: tByte=rom[HL]; BIT(6,A); rom[HL]=tByte; break;
...
case BIT_7_dHL: tByte=rom[HL]; BIT(7,A); rom[HL]=tByte; break;
...
case SET_0_dHL: tByte=rom[HL]; SET(0,A); rom[HL]=tByte; break;
...
case SET_1_dHL: tByte=rom[HL]; SET(1,A); rom[HL]=tByte; break;
...
case SET_2_dHL: tByte=rom[HL]; SET(2,A); rom[HL]=tByte; break;
...
case SET_3_dHL: tByte=rom[HL]; SET(3,A); rom[HL]=tByte; break;
...
case SET_4_dHL: tByte=rom[HL]; SET(4,A); rom[HL]=tByte; break;
...
case SET_5_dHL: tByte=rom[HL]; SET(5,A); rom[HL]=tByte; break;
...
case SET_6_dHL: tByte=rom[HL]; SET(6,A); rom[HL]=tByte; break;
...
case SET_7_dHL: tByte=rom[HL]; SET(7,A); rom[HL]=tByte; break;
...
case RES_0_dHL: tByte=rom[HL]; RES(0,A); rom[HL]=tByte; break;
...
case RES_1_dHL: tByte=rom[HL]; RES(1,A); rom[HL]=tByte; break;
...
case RES_2_dHL: tByte=rom[HL]; RES(2,A); rom[HL]=tByte; break;
...
case RES_3_dHL: tByte=rom[HL]; RES(3,A); rom[HL]=tByte; break;
...
case RES_4_dHL: tByte=rom[HL]; RES(4,A); rom[HL]=tByte; break;
...
case RES_5_dHL: tByte=rom[HL]; RES(5,A); rom[HL]=tByte; break;
...
case RES_6_dHL: tByte=rom[HL]; RES(6,A); rom[HL]=tByte; break;
...
case RES_7_dHL: tByte=rom[HL]; RES(7,A); rom[HL]=tByte; break;
